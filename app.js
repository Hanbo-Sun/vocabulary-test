...
const I18N = {
  ...
  es: {
    ...
    packHelp:
      "Columnas CSV: `word` (palabra) o `character` (carácter), `rank` (opcional: `band`, `range`). El tipo de unidad y el tamaño de banda ayudan a generar rangos. El JSON debe seguir el esquema.",
    themeLabel: "Tema",
    themeGlow: "Brillo",
    themePaper: "Papel",
    themeAuto: "Auto",
    ...
    errorCsvMissingColumn: "El CSV debe incluir una columna `word` (palabra) o `character` (carácter).",
  ...
  "zh-Hans": {
    ...
    importButton: "导入",
    packHelp:
      "CSV 列：`word`（词）或 `character`（字符），`rank`（可选：`band`、`range`）。单位与频段大小可自动生成范围。JSON 需符合示例结构。",
    themeLabel: "主题",
    themeGlow: "柔光",
    themePaper: "纸感",
    themeAuto: "自动",
    ...
    errorCsvMissingColumn: "CSV 需要包含 `word`（词）或 `character`（字符）列。",
  ...
  "zh-Hant": {
    ...
    importButton: "匯入",
    packHelp:
      "CSV 欄位：`word`（詞）或 `character`（字元），`rank`（可選：`band`、`range`）。單位與頻段大小可自動生成範圍。JSON 需符合示例結構。",
    themeLabel: "主題",
    themeGlow: "柔光",
    themePaper: "紙感",
    themeAuto: "自動",
    ...
    errorCsvMissingColumn: "CSV 需要包含 `word`（詞）或 `character`（字元）欄位。",
  ...
  fr: {
    ...
    packHelp:
      "Colonnes CSV : `word` (mot) ou `character` (caractère), `rank` (optionnel : `band`, `range`). Le type d’unité et la taille de bande aident à générer les plages. Le JSON doit suivre le schéma.",
    themeLabel: "Thème",
    ...
    errorCsvMissingColumn: "Le CSV doit contenir une colonne `word` (mot) ou `character` (caractère).",
  ...
  de: {
    ...
    packHelp:
      "CSV-Spalten: `word` (Wort) oder `character` (Zeichen), `rank` (optional: `band`, `range`). Einheitstyp und Bandgröße helfen bei der Bereichsbildung. JSON muss dem Schema folgen.",
    themeLabel: "Thema",
    themeGlow: "Glow",
    themePaper: "Papier",
    themeAuto: "Auto",
    ...
    errorCsvMissingColumn: "CSV muss eine Spalte `word` (Wort) oder `character` (Zeichen) enthalten.",
  ...
  ja: {
    ...
    importButton: "読み込む",
    packHelp:
      "CSV 列: `word`（単語）または `character`（文字）、`rank`（任意: `band`、`range`）。単位とバンドサイズで範囲を生成できます。JSON は既存の形式に合わせてください。",
    themeLabel: "テーマ",
    themeGlow: "グロー",
    themePaper: "ペーパー",
    themeAuto: "自動",
    ...
    errorCsvMissingColumn: "CSV に `word`（単語）または `character`（文字）列が必要です。",
  ...
  ko: {
    ...
    importButton: "가져오기",
    packHelp:
      "CSV 열: `word`(단어) 또는 `character`(문자), `rank`(선택: `band`, `range`). 단위와 밴드 크기를 이용해 범위를 생성합니다. JSON은 기존 스키마를 따라야 합니다.",
    themeLabel: "테마",
    themeGlow: "글로우",
    themePaper: "페이퍼",
    themeAuto: "자동",
    ...
    errorCsvMissingColumn: "CSV에는 `word`(단어) 또는 `character`(문자) 열이 필요합니다.",
